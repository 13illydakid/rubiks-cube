// Legacy shim preserved to avoid confusion and accidental imports.
// This re-exports the actual JSX-based App component.
...
componentDidMount() {
  ...
  for (let i = 0; i < rubiksObject.length; i++) {
    ...
    // const cubeMaterials = [
    //   new THREE.MeshBasicMaterial({ map: loader ,transparent: true,opacity:1, color:rubiksObject[i][2], side: THREE.FrontSide}), // red
    //   new THREE.MeshBasicMaterial({ map: loader ,transparent: true,opacity:1, color:rubiksObject[i][4], side: THREE.FrontSide}), // orange
    //   new THREE.MeshBasicMaterial({ map: loader ,transparent: true,opacity:1, color:rubiksObject[i][3], side: THREE.FrontSide}), // yellow
    //   // new THREE.MeshBasicMaterial({ map: loader ,transparent: true,opacity:1, color:rubiksObject[i][3], side: THREE.BackSide}), // yellow
    //   new THREE.MeshBasicMaterial({ map: loader ,transparent: true,opacity:1,}), // white
    //   new THREE.MeshBasicMaterial({ map: loader ,transparent: true,opacity:1, color:rubiksObject[i][1], side: THREE.FrontSide}), // blue
    //   new THREE.MeshBasicMaterial({ map: loader ,transparent: true,opacity:1, color:rubiksObject[i][5], side: THREE.FrontSide}), // green
    // ];
