...
/*
const one = convertRuwixAlgo("M'M'UMUUM'UM'M'");
const two = convertRuwixAlgo("M'M'U'MUUM'U'M'M'");
const three = convertRuwixAlgo("M'M'UM'M'UUM'M'UM'M'");
const four = convertRuwixAlgo("M'UM'M'UM'M'UM'UUM'M'U");
const five = convertRuwixAlgo("x'RRDDR'U'RDDR'UR'");
const six = convertRuwixAlgo("x'RU'RDDR'URDDRR");
const seven = convertRuwixAlgo("x'RU'R'DRUR'D'RUR'DRU'R'D'");
const eight = convertRuwixAlgo("RUR'U'R'FRRU'R'U'RUR'F'");
const nine = convertRuwixAlgo("R'U'F'RUR'U'R'FRRU'R'U'RUR'UR");
const ten = convertRuwixAlgo("R'URU'R'f'U'RU'U'R'U'RU'R'fR");
const eleven = convertRuwixAlgo("FRU'R'U'RUR'F'RUR'U'R'FRF'");
const twelve = convertRuwixAlgo("zU'RD'RRUR'U'RRUDR'");
const thirteen = convertRuwixAlgo("RUR'F'RUR'U'R'FRRU'R'U'");
const fourteen = convertRuwixAlgo("R'UURU'U'R'FRUF'U'R'F'RRU'");
const fifteen = convertRuwixAlgo("RU'R'U'RURDR'U'RD'R'UUR'U'");
const sixteen = convertRuwixAlgo("R'R'u'RU'RUR'uRRfR'f'");
const seventeen = convertRuwixAlgo("RUR'y'RRu'RU'R'UR'uRR");
const eighteen = convertRuwixAlgo("RRuR'UR'U'Ru'R'R'F'UF");
const nineteen = convertRuwixAlgo("R'd'FRRuR'URU'Ru'R'R'");
const twenty = convertRuwixAlgo("R'URU'R'F'U'FRUR'FR'F'RU'R");
const twentyone= convertRuwixAlgo("RUR'URUR'F'RUR'U'R'FRRU'R'UURU'R'");
*/
